        ...
        <div class="dashboard-wrapper">
           <div class="card">
               ...
               <div class="card-header">
                   ...
                   <a href="{{route('admin_faq_add')}}" type="button" class="btn btn-block btn-info" style="width: 120px" >Add FAQ</a>
                                   ...
                                   <table class="table table-striped table-bordered first">
                                       ...
                                       @foreach (  $datalist as $rs  )
                                           <tr>
                                               ...
                                               <td><a href="{{route('admin_faq_edit',['id'=> $rs->id])}}"> <img src="{{asset('assets/admin/images')}}/edit.jpg" height="25"> </a></td>
