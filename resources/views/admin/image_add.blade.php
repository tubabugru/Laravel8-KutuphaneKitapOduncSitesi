...
<body>
           ...
           <div class="card">
               <form role="form" action="{{route('admin_image_store',['book_id'=>$data->id])}}" method="post" enctype="multipart/form-data">
                   @csrf
                   <div class="card-body">
                           ...
                           <table class="table table-striped table-bordered first">
                               ...
                               @foreach (  $images as $rs  )
                                   <tr>
                                       ...
                                       <td>
                                           <a href="{{route('admin_image_delete',['id'=> $rs->id,'book_id'=>$data->id])}}" onclick="return confirm('Record will be Delete! Are you sure?')"><img src="{{asset('assets/admin/images')}}/delete.png" height="25"> </a>
                                       </td>
                                   </tr>
                               @endforeach
                               </tbody>
